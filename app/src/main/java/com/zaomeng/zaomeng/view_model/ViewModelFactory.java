...
public class ViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        ...
        } else if (modelClass.isAssignableFrom(ShopDetailVM.class)) {
        ...
        } else if (modelClass.isAssignableFrom(ChoseAddressVM.class)) {
            return (T) new ChoseAddressVM(application, apiService);
        } else if (modelClass.isAssignableFrom(AfterSaleOrderFragmentVM.class)) {
            return (T) new AfterSaleOrderFragmentVM(application, apiService);
        } else if (modelClass.isAssignableFrom(AfterSaleRecordFragmentVM.class)) {
            return (T) new AfterSaleRecordFragmentVM(application, apiService);
        } else if (modelClass.isAssignableFrom(AfterSaleDetailsVM.class)) {
            return (T) new AfterSaleDetailsVM(application, apiService);
        } else if (modelClass.isAssignableFrom(MeFragmentVM.class)) {
            return (T) new MeFragmentVM(application, apiService);
        }
