 ...
 * FastAndroid
 * {@link com.zaomeng.zaomeng.view.BonusFragment}
 */
public class BonusFragmentVM extends ListViewModel<Integer, BonusBean> {
    private ApiService apiService;
    private String sessionID;

    public BonusFragmentVM(@NonNull Application application, ApiService apiService) {
        super(application);
    ...
    public Call<PageBean<BonusBean>> setLoadInitialCall(PageKeyedDataSource.LoadInitialParams<Integer> params) {
        int listRequest = (int) this.listRequest;
        switch (listRequest) {
            case 1:
                return apiService.getMyMemberBonusList(sessionID, 1);
            case 2:
                return apiService.getMyMemberBonusList(sessionID, 2);
            case 3:
                return apiService.getMyMemberBonusList(sessionID, 3);
            default:
                return apiService.getMyMemberBonusList(sessionID, 1);
        }
    }
