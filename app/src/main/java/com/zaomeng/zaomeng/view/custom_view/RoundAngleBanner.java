 ...
 * @author ybao
 */
public class RoundAngleBanner extends Banner {
    ...
    public RoundAngleBanner(Context context) {
        this(context, null);
    }

    public RoundAngleBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundAngleBanner(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RoundAngleBanner);
            float radius = ta.getDimension(R.styleable.RoundAngleBanner_radius, 0);
            topLeftRadius = ta.getDimension(R.styleable.RoundAngleBanner_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.RoundAngleBanner_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.RoundAngleBanner_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.RoundAngleBanner_bottomRightRadius, radius);
            ta.recycle();
        }
